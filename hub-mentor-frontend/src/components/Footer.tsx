...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Refund Policy", to: "/cancellations-and-refunds" },
    ],
  },
];
    ...
    <footer className="mt-auto bg-slate-900 text-slate-300">
      <div className="container-wide py-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2.5">
              ...
              <span className="font-display text-xl font-extrabold tracking-tight text-white">
                Scholar<span className="text-brand-violet">Hub</span>
              </span>
            </Link>
            <p className="mt-4 max-w-sm text-sm text-slate-400">
              Connecting students with expert mentors for personalized academic
              guidance and lasting growth.
            </p>
            <div className="mt-6 flex gap-3">
              {socials.map((s) => (
                <a
                  key={s.label}
                  href={s.href}
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-slate-400 transition hover:bg-primary hover:text-white"
                >
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 md:flex-row">
          ...
          <p className="text-sm text-slate-500">Gateway to expert learning.</p>
        </div>
      </div>
    </footer>
  );
