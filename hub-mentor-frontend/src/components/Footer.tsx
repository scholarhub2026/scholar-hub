        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Connecting students with expert mentors for academic and personal growth.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/mentors" className="text-muted-foreground hover:text-primary transition">
                  Find Mentors
                </Link>
              </li>
              {/* <li>
              ...
              {/* <li>
                <Link to="/resources" className="text-muted-foreground hover:text-primary transition">
                  Resources
                </Link>
              </li> */}
              <li>
                <Link to="/become-mentor" className="text-muted-foreground hover:text-primary transition">
                  Become a Mentor
                </Link>
              </li>
            </ul>
